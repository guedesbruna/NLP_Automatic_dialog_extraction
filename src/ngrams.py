...
def emission_probs(df, ngrams_prob):
    ...
    return df, uni, bi_past, tri_past, bi_fut, tri_fut
...
def main(argv=None):
    ...
    perplexity(unigram)
    df, uni, bi_past, tri_past, bi_fut, tri_fut = emission_probs(df, ngrams_prob)

    input_hmm = {'unigram': unigram, 'uni':uni, 'bi_fut':bi_fut, 'bi_past':bi_past, 'tri_fut':tri_fut, 'tri_past':tri_past, 'unique_ids': unique_ids}
